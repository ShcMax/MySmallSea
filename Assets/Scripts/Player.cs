...
{   
    ...
    public Action<float> changeHealth; // событие для графическое отображение здоровья
    ...
    public float PlayerMaxHealth => playerMaxHealth; // свойство для отображения здоровья
    private void Awake()
    {
